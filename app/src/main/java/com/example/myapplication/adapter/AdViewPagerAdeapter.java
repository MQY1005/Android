...
public class AdViewPagerAdeapter extends PagerAdapter {
    private List<ImageView> imageViews;
    public AdViewPagerAdeapter() {
    ...
    public AdViewPagerAdeapter(List<ImageView> imageViews) {
        super();
...
//                handler.sendEmptyMessageDelayed(CourseFragment.MSG_AD_ID, 5000);
